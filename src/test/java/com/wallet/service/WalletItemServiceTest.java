...
public class WalletItemServiceTest {
    ...
    public void testSave() {
        BDDMockito.given(repository.save(Mockito.any(WalletItem.class)))
    ...
    public void testFindBetweenDates() {
        ...
        BDDMockito.given(repository
                .findAllByWalletIdAndDateGreaterThanEqualAndDateLessThanEqual(Mockito.anyLong(),
                Mockito.any(Date.class), Mockito.any(Date.class), Mockito.any(PageRequest.class)))
            .willReturn(page);

        Page<WalletItem> response = service.findBetweenDays(1L, new Date(), new Date(), 0);
    ...
    public void testFindByType() {
        ...
        assertEquals(response.get(0).getWallet().getId(), 1L);
    }

    @Test
    public void testSumByWallet() {
        BigDecimal value = BigDecimal.valueOf(100);
        BDDMockito.given(repository.sumByWallet(Mockito.anyLong()))
            .willReturn(value);
